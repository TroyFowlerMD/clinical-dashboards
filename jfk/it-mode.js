(function () {
  ...
  function init() { injectStyles(); var autoEnter = consumeAutoEnter(); ensureEntryButton(); pageObserver = new MutationObserver(function () { if (!enabled) ensureEntryButton(); }); pageObserver.observe(document.body, { childList: true, subtree: true }); if (autoEnter) enterItMode(); }
